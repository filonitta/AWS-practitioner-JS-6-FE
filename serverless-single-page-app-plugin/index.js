...
class ServerlessPlugin {
  ...
  runAwsCommand(args) {
    ...
    const stdout =
      typeof result.stdout === "string" ? result.stdout : result.stdout && result.stdout.toString();
    const sterr =
      typeof result.stderr === "string" ? result.stderr : result.stderr && result.stderr.toString();
    if (stdout) {
